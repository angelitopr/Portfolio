...
Original file is located at
    https://colab.research.google.com/drive/1dGeNYy_9yBEP411TI8W7EJigC-er7KLk
"""
...
for imagen, etiqueta in datos_entrenamiento.take(7):
  break
...
for imagenes_prueba, etiqueta_prueba in datos_pruebas.take(1):
  ...
  etiquetas_prueba = etiqueta_prueba.numpy()
...
def graficar_imagen(i, arr_predicciones, etiquetas_reales, imagenes):
  ...
  if etiqueta_prediccion == np.argmax(arr_predicciones):
    color = 'blue'
  else:
    color = 'red'
...
def graficar_valor_arreglo(i, arr_predicciones, etiquetas_reales):
  arr_pred, etiqueta_real = arr_predicciones[i], etiquetas_reales[i]
  plt.grid(False)
  plt.xticks([])
  plt.yticks([])
  grafica = plt.bar(range(10), arr_pred, color="#777777")
  plt.ylim([0,1])
  etiqueta_prediccion = np.argmax(arr_pred)
